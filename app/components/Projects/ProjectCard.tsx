...
const ProjectCard = ({ title, associated, date, imageUrl }: ProjectCardProps) => {
  return (
    ...
    <div className="self-stretch px-5 py-4 bg-dark-grey inline-flex justify-between items-center overflow-hidden">
        <div className="inline-flex flex-col justify-start items-start gap-[3px]">
              <div className="justify-start text-white text-sm font-bold font-sans leading-none">{title}</div>
            <div className="justify-start text-white text-sm font-normal font-sans">{associated}</div>
            <div className="justify-start text-white text-sm font-normal font-sans">{date}</div>
        </div>
